...
function styles() {
  return src("app/assets/scss/main.scss") // Выбираем источник: "app/sass/main.sass"
...
async function images() {
  imagecomp(
    "app/assets/img/**/*", // Берём все изображения из папки источника
    "app/assets/img/dest/", // Выгружаем оптимизированные изображения в папку назначения
...
function cleanimg() {
  return del("app/assets/img/*", { force: true }); // Удаляем все содержимое папки "app/images/"
}
...
function startwatch() {
  ...
  watch(["app/assets/**/*.js", "!app/**/*.min.js"], scripts);

  // Мониторим файлы препроцессора на изменения
  watch("app/assets/**/scss/**/*", styles);
